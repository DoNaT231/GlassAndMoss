    ...
    <div className="min-h-screen bg-[#0b0f0a] text-white">
      ...
      <div className="max-w-[800px] mx-auto px-4 md:px-10 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="type-body space-y-8">
          <section>
            <h2 className="type-heading mb-4">1. Mi az a cookie?</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">2. Milyen cookie-kat használunk?</h2>
          ...
          <section>
            <h2 className="type-heading mb-4">3. Cookie-k kezelése</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">4. Böngésző beállítások</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">5. További információ</h2>
            <p>
