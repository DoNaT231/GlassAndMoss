    ...
    <div className="min-h-screen bg-[#0b0f0a] text-white">
      ...
      <div className="max-w-[800px] mx-auto px-4 md:px-10 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="type-body space-y-8">
          <section>
            <h2 className="type-heading mb-4">1. Előírások alanya</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">2. Szolgáltatások / Termékek</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">3. Megrendelés és szerződéskötés</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">4. Árak és fizetés</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">5. Szállítás / Átvétel</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">6. Szavatosság és reklamáció</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">7. Elállás (fogyasztói vásárlás esetén)</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">8. Panaszkezelés és békéltető testület</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">9. Online vitarendezés</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">10. Egyéb rendelkezések</h2>
            <p>
          ...
          <section>
            <h2 className="type-heading mb-4">11. Kapcsolat</h2>
            <p>
              Kérdés esetén:{" "}
